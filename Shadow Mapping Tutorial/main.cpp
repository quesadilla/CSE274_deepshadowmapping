...
VECTOR3D cameraPosition(-1.5f, 2.5f,-3.5f);
VECTOR3D lightPosition(2.0f, 3.0f,-2.0f);
...
bool Init(void)
{
	...
	bunny = ParserObj("bunny");
	bunny.parse("bunny.obj");
	std::cout << "done parsing bunny. " << std::endl;
	std::cout << "parsing hairball..." << std::endl;
	hairball = ParserObj("hairball");
	hairball.parse("hairball_simplified.obj");
	std::cout << "done parsing hairball. " << std::endl;

	hairball.setScale(.5);
	hairball.setScale2(.25);
	drawHairball = false;
